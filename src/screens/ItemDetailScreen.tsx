...
const styles = StyleSheet.create({
  ...
  carryButton: { backgroundColor: C.accent, borderRadius: 10, paddingVertical: 14, alignItems: 'center', marginBottom: 12 },
  carryButtonText: { color: C.text, fontSize: 16, fontWeight: '600' },
  actionRow: { flexDirection: 'row', gap: 10, marginBottom: 24 },
  secondaryButton: { flex: 1, borderWidth: 1, borderColor: C.border, borderRadius: 8, paddingVertical: 10, alignItems: 'center' },
  ...
  streakBadge: { flex: 1, backgroundColor: C.bgCard, borderRadius: 10, padding: 14, alignItems: 'center' },
  ...
  sectionHeader: { fontSize: 13, fontWeight: '600', color: C.textMuted, textTransform: 'uppercase', letterSpacing: 0.6, marginTop: 24, marginBottom: 10 },
  ...
  collectionChip: { paddingHorizontal: 14, paddingVertical: 6, borderRadius: 16, borderWidth: 1, borderColor: C.border },
  ...
  tagChip: { paddingHorizontal: 12, paddingVertical: 5, borderRadius: 14, borderWidth: 1, borderColor: C.border },
  ...
  tagInput: { flex: 1, borderWidth: 1, borderColor: C.border, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 8, fontSize: 14, backgroundColor: C.bgInput, color: C.text },
  tagAddButton: { backgroundColor: C.teal, borderRadius: 8, paddingHorizontal: 16, paddingVertical: 8, justifyContent: 'center' },
  tagAddText: { color: C.text, fontWeight: '600', fontSize: 14 },
  logSection: { marginTop: 28 },
  logHeader: { fontSize: 13, fontWeight: '600', color: C.textMuted, textTransform: 'uppercase', letterSpacing: 0.6, marginBottom: 12 },
  logEmpty: { fontSize: 14, color: C.textMuted },
  logCard: { borderWidth: 1, borderColor: C.border, borderRadius: 8, padding: 12, marginBottom: 10, backgroundColor: C.bgCard },
